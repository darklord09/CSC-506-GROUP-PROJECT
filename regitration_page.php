<?php
  ...
  if (isset($_POST['submit'])) {
    ...
    $insert = $dbconnect->query("INSERT INTO users (firstName, surName, email, phoneNumber, address, password) VALUES('$first_name', '$sur_name', '$email', '$address', '$phone_number', '$password')") or die($dbconnect->error); 
